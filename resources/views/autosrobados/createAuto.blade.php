    ...
    <body>
        ...
        <section>
            ...
            <div class="col-auto">
                ...
                <label for="marca">Marca:</label><input value="{{old('marca')}}" class="form-control mb-2" style="width: 50%"  name='marca' type="text" required>
                @error('marca')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="col-auto">
                <label for="modelo">Modelo:</label><input value="{{old('modelo')}}" class="form-control mb-2" style="width: 50%" name='modelo'  type="text" required>
                @error('modelo')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            <div class="col-auto">
            </div>
                <label for="fecha">Feca de robo:</label><input value="{{old('fecha')}}" class="form-control mb-2" style="width: 30%" name='fecha' type="date" required><br>
                @error('fecha')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            <div class="col-auto">
